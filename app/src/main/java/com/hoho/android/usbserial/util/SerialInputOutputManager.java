...
public class SerialInputOutputManager implements Runnable {
     ...
     */
    public SerialInputOutputManager(UsbSerialPort driver, SerialPortListener listener) {
        mDriver = driver;
        mListener = listener;
    }

    public synchronized void setListener(SerialPortListener listener) {
        mListener = listener;
    }

    public synchronized SerialPortListener getListener() {
        return mListener;
    }

    public void writeAsync(byte[] data) {
        synchronized (mWriteBuffer) {
            if((BUFSIZ - mWriteBuffer.position()) > data.length){
    ...
    public void run() {
        ...
        try {
            ...
            final SerialPortListener listener = getListener();
            if (listener != null) {
